...
if (isset($_POST['submit'])){
    ...
    copy($_FILES['upload']['tmp_name'], "".$filepath1."".$_FILES['upload']['name']);
    $pic1 = ("".$filepath1."".$_FILES['upload']['name']);

    //helo
    $sql = "INSERT INTO admin (fullname,email,username,password,passport)
                                VALUES(
                                '$fullname',
                                '$email',
                                '$username',
...
<body class="disable_transitions sidebar_main_open sidebar_main_swipe">
    ...
    <div id="page_content">
        <div id="page_content_inner">
            ...
            <div class="md-card">
                <form method="POST" action="forms_regular.php" enctype="multipart/form-data">
                <div class="md-card-content">
                    <h3 class="heading_a">Admin Users</h3>
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-2">
                            <div class="uk-form-row">
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-1-2">
                                        ...
                                        <input type="text" name = "lastname" class="md-input label-fixed" />
                                    </div>
                                </div>
                            </div>
                            <div class="uk-form-row">
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-1-2">
                                        ...
                                        <input type="password" name = "password" class="md-input label-fixed" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="uk-form-row">
                                <label></label>
                                <input type="file" class="md-input"  name="upload" />
                            </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        ...
                        <div class="uk-width-large-1-4 uk-width-medium-1-2">
                            <div class="uk-input-group">
                                <span class="uk-input-group-addon"><button class="md-btn" name="submit">Save</button></span>
                            </div>
                        </div>
...
<!-- Mirrored from altair_html.tzdthemes.com/forms_regular.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Nov 2018 04:38:58 GMT -->
</html>