...
if (isset($_SESSION['ulogin'])){
    ...
    $tm = "select * from members ";
    $t1 =  mysqli_query($conn,$tm);
    $n1 =  mysqli_num_rows($t1);

    //get the total number of unapproved members 
    $tm0 = "select * from members where approval = 'pending' ";
    $t10 =  mysqli_query($conn,$tm);
    $n10 =  mysqli_num_rows($t10);
    //get total of approved members
    $tm1 = "select * from members where approval = 'approved' ";
    $t11 =  mysqli_query($conn,$tm1);
    $n11 =  mysqli_num_rows($t11);
    //get total number of admins
    $tm2 = "select * from admin ";
    $t12 =  mysqli_query($conn,$tm2);
    $n12 =  mysqli_num_rows($t12);
...
<body class="disable_transitions sidebar_main_open sidebar_main_swipe">
    ...
    <aside id="sidebar_main">
        ...
        <div class="menu_section">
            <ul>
                ...
                <li title="Forms">
                    <a href="forms_regular.php">
                        <span class="menu_icon"><i class="material-icons">&#xE8D2;</i></span>
                        <span class="menu_title">Add Users</span>
                    </a>
                ...
                <li title="Plugins">
                    <a href="database.php">
                        <span class="menu_icon"><i class="material-icons">&#xE8C0;</i></span>
                        <span class="menu_title">Database</span>
                    </a>
 ...
 <h4 class="heading_a uk-margin-bottom">User Table</h4>
...
<?php
                    ...
                    $y = "select * from members";
                    $x = mysqli_query($conn,$y);
                        ...
                        while ($row = mysqli_fetch_assoc($x)) {
                            ...
                            <td>'. $row['employer_phone'] .'</td>
                            <td>'. $row['passport'] .'</td>
                            <td>'. $row['primary_school'] .'</td>
                            <td>'. $row['olevel'] .'</td>
                            <td>'. $row['higher_result'] .'</td>
                            <td>'. $row['approval'] .'</td>
                            
                            <td>
                            <a href="approved.php?id='. $row['id'] .' ">
                            <button style="background-color: green; color: white; border: 0px; border-radius: 5px;">approve</button></a>
                            &nbsp;
                            <a href="reject.php?id='. $row['id'] .' ">
                            <button style="background-color: red; color: white; border: 0px; border-radius: 5px;">Reject</button></a>
                             </td>
                        </tr>';
                        }
...
<!-- Mirrored from altair_html.tzdthemes.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Nov 2018 04:35:39 GMT -->
</html>